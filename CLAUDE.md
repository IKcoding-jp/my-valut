...
**memory_logsのスコープルール**:
- ✅ 書くもの: 学習の方針変更・合意事項、心理状態の重要な変化、学習セッションの要点サマリー、キャリア関連の決定事項
- ❌ 書かないもの: 生活関連メモ（美容院・買い物等→`ideas/`へ）、詳細な成績データ（→学習記録・進捗ログへ）、一時的な情報（今日の予定等→ジャーナルへ）
...
3. **memory_logs.mdの同時更新**: 学習記録を作成したら、必ずmemory_logs.mdにもその日の要点を追記する
