...
以下を読み込んで現状を把握する:
1. `learning/memory_logs.md` — 最新の心理状態・マイルストーン
2. `learning/進捗ログ.md` — セッション履歴・正答率・擬似言語習熟度
3. `学習記録/` の最新2-3日分 — 学習頻度・学習量・自己評価の推移
4. `learning/学習計画書_資格同時取得.md` — 残り日数・進捗状況
...
`learning/進捗ログ.md` と `learning/memory_logs.md` のデータから成長を可視化する。
...
以下の場合のみ、`learning/memory_logs.md` に追記する:
