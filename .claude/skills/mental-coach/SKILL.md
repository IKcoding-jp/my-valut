...
triggers:
  - 「つらい」「くじけそう」「やる気が出ない」「疲れた」
  - 「不安」「落ちるかも」「間に合わない」「怖い」
  - 「自信がない」「無理かも」「やめたい」
  - 「メンタル」「励まして」「元気が出ない」
  - 他スキルからの暗黙的トリガー（連続不正解、長期空白等）
---
...
以下を読み込んで現状を把握する:
1. `docs/memory_logs.md` — 最新の心理状態・マイルストーン
2. `learning_progress.md` — セッション履歴・正答率・擬似言語習熟度
3. `学習記録/` の最新2-3日分 — 学習頻度・学習量・自己評価の推移
4. `学習計画表.md` — 残り日数・進捗状況
...
`learning_progress.md` と `docs/memory_logs.md` のデータから成長を可視化する。
...
以下の場合のみ、`docs/memory_logs.md` に追記する:
