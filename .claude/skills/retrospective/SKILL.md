...
読み込むファイル:
1. `learning/進捗ログ.md` — 現在のダッシュボード数値
2. `学習記録/` — 対象期間の全日次記録
3. `learning/memory_logs.md` — 対象期間のマイルストーン・合意事項
4. `learning/学習計画書_資格同時取得.md` — 週別スケジュール（計画 vs 実績の比較用）
...
- このスキルは **memory_logs.md と学習記録への追記のみ** 行う（learning/進捗ログ.md は更新しない）
- learning/学習計画書_資格同時取得.md への直接編集は **ユーザーの合意を得てから** 行う
