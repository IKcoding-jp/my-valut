...
1. **`learning/基本情報技術者/進捗ログ.md`** — 分野別正答率、危険問題リスト、セッション履歴
2. **`learning/基本情報技術者/学習計画表.md`** — 現在のフェーズ、週別スケジュール
3. **`memory_logs.md`** — 直近2-3エントリ（心理状態・マイルストーン）
4. **`learning/基本情報技術者/学習記録/`** — 最新3日分（空白期間・つまずきの検知）
...
- `learning/基本情報技術者/進捗ログ.md`、`learning/基本情報技術者/学習計画表.md`、`memory_logs.md` は**読み取り専用**
