...
difficulty: 3
status: 未学習
source: "出典：平成21年秋期 基本情報技術者試験 科目A 問69"
source_url: "https://www.fe-siken.com/kakomon/21_aki/q69.html"
last_attempt: null
confidence_history: []
result_history: []
time_spent_seconds: []
...
## 問題
ある製品の設定価格と期待需要の関係が1次式で表せるとき， a に入る適切な数値はどれか。設定価格を3,000円にすると，需要は0になる。設定価格を1,000円にすると，需要は60,000個になる。設定価格を1,500円にすると，需要はa個になる。
